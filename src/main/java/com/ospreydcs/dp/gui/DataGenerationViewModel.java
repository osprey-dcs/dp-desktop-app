...
public class DataGenerationViewModel {
    ...
    /*
     * Sample status generation, applying to every PV generated by this view.  Off by default:
     * when unchecked the generation path is unchanged and no statuses are saved.  This is a plain
     * view control rather than component state, so unlike tags and attributes it lives on the
     * ViewModel and is bound bidirectionally to the checkbox.
     */
    private final BooleanProperty generateSampleStatuses = new SimpleBooleanProperty(false);
    ...
    // Sample status property getters
    public BooleanProperty generateSampleStatusesProperty() { return generateSampleStatuses; }
    public boolean isGenerateSampleStatuses() { return generateSampleStatuses.get(); }
    public void setGenerateSampleStatuses(boolean value) { generateSampleStatuses.set(value); }
